...
namespace CurvaStore.Migrations
{
    ...
    [Migration("20240815203011_editCurvaUser")]
    partial class editCurvaUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CurvaStore.Models.Cart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("colorsizeProductId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("colorSizeId", "colorsizeProductId");
            ...
            modelBuilder.Entity("CurvaStore.Models.CurvaUser", b =>
                {
            ...
            modelBuilder.Entity("CurvaStore.Models.WishList", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CurvaStore.Models.Cart", b =>
                {
                    b.HasOne("CurvaStore.Models.Product", "product")
                        .WithMany()
                        .HasForeignKey("productId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CurvaStore.Models.ColorSize", "colorsize")
                        .WithMany()
                        .HasForeignKey("colorSizeId", "colorsizeProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CurvaStore.Models.CurvaUser", null)
                        .WithMany()
